export default {
  ...
  fields: [
    ...
    { name: "summary_es", type: "text", title: "Resumen (ES)", options: { maxLength: 50 }, validation: (Rule: any) => Rule.required() },
    ...
    { name: "summary_en", type: "text", title: "Summary (EN)" , options: { maxLength: 50 }, validation: (Rule: any) => Rule.required()},
