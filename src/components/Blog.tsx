      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center w-full">
          <div className="flex flex-col sm:flex-row sm:justify-between w-full mb-1">
            <h2 className="text-lg font-bold font-playfair text-clay group-hover:underline transition mb-1 sm:mb-0">
              {article.title}
            </h2>
            {article.date && (
              <span className="text-xs text-white/70 sm:ml-4 whitespace-nowrap text-right">
